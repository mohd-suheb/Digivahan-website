      ...
      <section className="w-full bg-gray-200 py-8 px-4 md:px-6 flex justify-center">
        <div className="bg-white shadow-lg rounded-2xl flex flex-col md:flex-row w-full max-w-4xl overflow-hidden">
          ...
          <div className="w-full md:w-1/2 flex justify-center items-center bg-yellow-50 p-4 md:p-0">
            <img src={formimg} alt="Contact Illustration" className="h-64 sm:h-80 md:h-[400px] w-auto" />
          </div>
          ...
          <div className="w-full md:w-1/2 p-6 sm:p-8 flex flex-col justify-center">
            ...
            <form className="space-y-3 sm:space-y-4">
              <input
                ...
                className="w-full px-3 sm:px-4 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-yellow-400"
              />
              ...
              <button
                type="submit"
                className="w-full bg-yellow-500 text-white font-semibold py-2 rounded-lg hover:bg-yellow-600 transition text-sm"
              >
                Send Message
              </button>
            </form>
