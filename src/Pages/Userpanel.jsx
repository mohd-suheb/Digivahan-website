  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white flex">
      ...
      <aside className="w-64 bg-gradient-to-b from-[#1e293b] to-[#0f172a] text-gray-200 flex flex-col p-10 shadow-xl">
        ...
        <button
          className="mt-auto flex items-center space-x-2 bg-indigo-600/30 hover:bg-indigo-500/60 rounded-lg px-8 py-4 transition"
          onClick={logout}
        >
          <LogOut className="w-5 h-5 text-indigo-400" />
          <span>Logout</span>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <nav className="px-6 py-4 border-b border-gray-700 bg-gray-800/60 shadow-md">
          <div className="flex justify-between items-center">
            <h1 className="text-xl font-semibold tracking-wide text-indigo-400">
              Dashboard
            </h1>
        ...
        <main className="flex-1 flex items-center justify-center px-6">
          <div className="max-w-2xl text-center space-y-6 bg-gray-800/60 p-8 rounded-2xl shadow-xl border border-gray-700 mt-10">
            <h2 className="text-3xl font-bold text-indigo-400">
              Welcome to User Dashboard
            </h2>
